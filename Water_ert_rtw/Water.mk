###########################################################################
## Makefile generated for Simulink model 'Water'. 
## 
## Makefile     : Water.mk
## Generated on : Tue May 26 16:02:39 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Water.exe
...
COMPILER_COMMAND_FILE     = Water_comp.rsp
CMD_FILE                  = Water.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Water.exe
...
DEFINES_STANDARD = -DMODEL=Water -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Water_ert_rtw\Water.c

MAIN_SRC = $(START_DIR)\Water_ert_rtw\ert_main.c
...
{$(START_DIR)\Water_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Water_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
